...
class SPLDatasetLoader():
    ...
    def __init__(
        ...
        self.negatives_file = negatives_file
    ...
    def load_data(self):
        ...
        console.log("[SPL] Loading collection from:",self.collection_file)
        self.collection = {}
        self.collection_ids = []
        ...
        console.log("[SPL] Loading queries from:",self.query_file)
        self.queries = {}
        ...
        console.log("[SPL] Loading pairs from:",self.pairs_with_teacher_scores)
        ...
        if self.uniform_percentile_sampling:
            console.log("[SPL] Creating balanced bins")
